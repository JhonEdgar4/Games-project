...
<main>
    <header class="header">
        ...
        <div class="header-content container">
            <div class="header-txt">
                ...
                <p>
                    En esta página encontraras juegos de terror de la plataforma de XBOX
                </p>
                <div class="buttons">
    ...
    <section class="popular container">
        <h2>juegos populare de terror</h2>

        <div class="popular-content">
            <img src="media/categoria_img/portada-resident-evil-village-xbox-one-.jpg" alt="">
            <img src="media/categoria_img/portada_the_evil.png" alt="">
            <img src="media/categoria_img/portada-bioshock-remastered-xbox-one.jpg" alt="">
            <img src="media/categoria_img/portada_the_Medium.jpg" alt="">
            <img src="media/categoria_img/portada-the-dark-pictures-anthology-house-of-ashes-xbox-one.jpg" alt="">
            <img src="media/categoria_img/portada_red_fall.jpg" alt="">
        </div>
    </section>
    ...
    <main id="product-content" class="product container">
        ...
        <div class="product-content">
            ...
            <div class="product-1">
                <img src="media/categoria_img/bioshock.pnj.avif" alt="">
                <div class="product-txt">
                    <h3>bioshock</h3>
                    <div class="price">
                        <p>$81.900</p>
            ...
            <div class="product-1">
                <img src="media/categoria_img/The_Medium.jpeg" alt="">
                <div class="product-txt">
                    <h3>The Medieum</h3>
                    <div class="price">
                        <p>$142.000</p>
            ...
            <div class="product-1">
                <img src="media/categoria_img/Darck_pictures.jpeg" alt="">
                <div class="product-txt">
                    <h3>Darck pictures</h3>
                    <div class="price">
                        <p>$62.700</p>
                        <a href="#" class="btn-2">Comprar</a>
                    </div>
            ...
            <div class="product-1">
                <img src="media/categoria_img/Redfall.jpeg" alt="">
                <div class="product-txt">
                    <h3>Red Fall</h3>
                    <div class="price">
                        <p>$80.000</p>
            ...
            <div class="product-1">
                <img src="media/categoria_img/the-outlast-trials.jpeg" alt="">
                <div class="product-txt">
            ...
            <div class="product-1">
                <img src="media/categoria_img/vampyr.jpeg" alt="">
                <div class="product-txt">
                    <h3>vampyr</h3>
                    <div class="price">
                        <p>$136.000</p>
            ...
            <div class="product-1">
                <img src="media/categoria_img/Atomic-Heart.jpeg" alt="">
                <div class="product-txt">
                    <h3>Atomic Heart</h3>
                    <div class="price">
                        <p>$70.000</p>
