...
<div class="main-container">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><button class='mark-btn'>Marcar</button></td>";
                        echo "</tr>";
                    }
                } else {
    ...
    <div id="contact-section">
        <section class="contact-content">
            ...
            <form id="checkout-form">
                ...
                <input type="text" id="identificacion" name="identificacion" placeholder="Número de identificación">
    ...
    <!-- Contenedor para la factura que se mostrará encima -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        checkoutForm.addEventListener('submit', function(event) {
            ...
            // Obtener datos del carrito excluyendo productos marcados
            ...
            // Mostrar la factura sobrepuesta en la pantalla
            facturaContent.innerHTML = generateInvoiceHTML(data, carrito);
