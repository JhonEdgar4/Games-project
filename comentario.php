...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        echo "<script>console.log('Comentario guardado exitosamente.');</script>";
    } else {
        echo "<script>console.log('Error al guardar el comentario: " . $conn->error . "');</script>";
    }
